...
import com.ssf.labtest.utils.SecretsConstant;
...
@Configuration
@DependsOn({"secrets"})
@EnableMongoRepositories(basePackages = "com.ssf.labtest")
public class MongoConfig extends AbstractMongoClientConfiguration {
    ...
    protected String getDatabaseName() {
        return environment + "-labtestservice";
    }
    ...
    public Collection<String> getMappingBasePackages() {
        return Collections.singleton("com.ssf.labtest");
    }
}