//package com.ssf.membership.config;
//
//
...
//@EnableNeo4jRepositories(transactionManagerRef = "graphTransactionManager", basePackages = "com.ssf.membership")
...
//        return new SessionFactory(configuration(), "com.ssf.membership");
//    }
//
