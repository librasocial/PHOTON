...
public class VisitLogControllerTest {
    ...
    public void whenValidInput_thenReturns201CreateVisitLog() throws Exception {
        ...
        mockMvc.perform(post("/pncservices/{serviceId}/visitlogs", MockDataConstant.SERVICE_ID)
    ...
    public void whenValidInput_thenReturns200readVisitLog() throws Exception {
        ...
        String actualResponse = mockMvc.perform(get("/pncservices/{serviceId}/visitlogs/{logId}", MockDataConstant.SERVICE_ID, MockDataConstant.LOG_ID)
    ...
    public void whenInvalidValidInput_thenReturns404readVisitLog() throws Exception {
        ...
        //call controller get api
        String errorRespString = mockMvc.perform(get("/pncservices/{serviceId}/visitlogs/{logId}", MockDataConstant.SERVICE_ID, MockDataConstant.LOG_ID)
                        .accept("application/json"))
    ...
    @Test
    public void whenServiceIdAndRchId_thenReturns200FilterVisitLog() throws Exception {
        VisitLogDto dto = MockDataConstant.buildSampleVislitLogDto();
        ...
        Mockito.when(service.filterVisitLog(MockDataConstant.SERVICE_ID, MockDataConstant.RCHID, 0, 5)).thenReturn(expected);
        String response = mockMvc.perform(get("/pncservices/visitlogs/filter")
                        .contentType("application/json")
    ...
    @Test
    public void whenServiceId_thenReturns200FilterVisitLog() throws Exception {
        VisitLogDto dto = MockDataConstant.buildSampleVislitLogDto();
        ...
        Mockito.when(service.filterVisitLog(MockDataConstant.SERVICE_ID, null, 0, 5)).thenReturn(expected);
        String response = mockMvc.perform(get("/pncservices/visitlogs/filter")
                        .contentType("application/json")
                        .param("serviceId", MockDataConstant.SERVICE_ID)
                        .accept("application/json"))
