...
(async () => {
  ...
  if (process.env.NODE_ENV === "test") {
    ...
    loadAWSJSONSecretsIntoENV(region, secretName, console.log).then(() => {
      DB_LINK = process.env.DB_LINK_MONGO;
      DB_LINK = DB_LINK.concat("/", profile).concat("-", "survey");
...
const actuatorOptions = {
  basePath: "/surveys", // It will set /management/info instead of /info
};
