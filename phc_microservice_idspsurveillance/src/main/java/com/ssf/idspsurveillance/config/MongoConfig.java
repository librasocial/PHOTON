...
@Configuration
@DependsOn({"secrets"})
@EnableMongoRepositories(basePackages = "com.ssf.idspsurveillance.repository")
public class MongoConfig extends AbstractMongoClientConfiguration {
    ...
    protected String getDatabaseName() {
        return environment + "-idspsurveillance";
    }
    ...
    public Collection<String> getMappingBasePackages() {
        return Collections.singleton("com.ssf.idspsurveillance.repository");
    }
}