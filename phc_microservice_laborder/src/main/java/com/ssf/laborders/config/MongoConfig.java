...
import com.ssf.laborders.utils.SecretsConstant;
...
@Configuration
@DependsOn({"secrets"})
@EnableMongoRepositories(basePackages = "com.ssf.laborders")
public class MongoConfig extends AbstractMongoClientConfiguration {
    ...
    public Collection<String> getMappingBasePackages() {
        return Collections.singleton("com.ssf.laborders");
    }
}