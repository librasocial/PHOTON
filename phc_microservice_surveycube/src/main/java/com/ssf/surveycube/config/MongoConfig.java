...
import com.ssf.surveycube.utils.SecretsConstant;
...
@Configuration
@DependsOn({"secrets"})
@EnableMongoRepositories(basePackages = "com.ssf.surveycube")
public class MongoConfig extends AbstractMongoClientConfiguration {
    ...
    public Collection<String> getMappingBasePackages() {
        return Collections.singleton("com.ssf.surveycube");
    }
}