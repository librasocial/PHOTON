...
public class VisitLogControllerTest {
    ...
    public void whenValidInput_thenReturns201CreateVisitLog() throws Exception {
        ...
        mockMvc.perform(post("/ecservices/{serviceId}/visitlogs", MockDataConstant.SERVICE_ID)
    ...
    public void whenValidInput_thenReturns200readVisitLog() throws Exception {
        ...
        String actualResponse = mockMvc.perform(get("/ecservices/{serviceId}/visitlogs/{logId}", MockDataConstant.SERVICE_ID, MockDataConstant.LOG_ID)
    ...
    public void whenInvalidValidInput_thenReturns404readVisitLog() throws Exception {
        ...
        //call controller get api
        String errorRespString = mockMvc.perform(get("/ecservices/{serviceId}/visitlogs/{logId}", MockDataConstant.SERVICE_ID, MockDataConstant.LOG_ID)
                        .accept("application/json"))
    ...
    public void whenServiceIdAndRchIdAndLogId_thenReturns200FilterVisitLog() throws Exception {
        ...
        String response = mockMvc.perform(get("/ecservices/visitlogs/filter")
                        .contentType("application/json")
