...
(async () => {
  ...
  console.log(process.env.profile);
    ...
    .then(() => {
        ...
        DB_LINK = DB_LINK.concat('/',profile).concat('-','medicalcondition')
...
const actuatorOptions = {
	basePath: "/medicalconditions", // It will set /management/info instead of /info
};
...
app.use("/medicalconditions", router);
