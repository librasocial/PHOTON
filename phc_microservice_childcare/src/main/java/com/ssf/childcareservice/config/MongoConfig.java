...
import com.ssf.childcareservice.utils.SecretsConstant;
...
@Configuration
@DependsOn({"secrets"})
@EnableMongoRepositories(basePackages = "com.ssf.childcareservice")
public class MongoConfig extends AbstractMongoClientConfiguration {
    ...
    protected String getDatabaseName() {
        return environment + "-childcareservice";
    }
    ...
    public Collection<String> getMappingBasePackages() {
        return Collections.singleton("com.ssf.childcareservice");
    }
}