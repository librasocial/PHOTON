package com.ssf.permissions.config;


import com.ssf.permissions.utils.SecretsConstant;
...
@EnableNeo4jRepositories(transactionManagerRef = "graphTransactionManager", basePackages = "com.ssf.permissions")
public class Neo4JConfig {
    ...
    public SessionFactory graphSessionFactory() {
        return new SessionFactory(configuration(), "com.ssf.permissions");
    }
