...
import com.ssf.ancservice.utils.SecretsConstant;
...
@Configuration
@DependsOn({"secrets"})
@EnableMongoRepositories(basePackages = "com.ssf.ancservice")
public class MongoConfig extends AbstractMongoClientConfiguration {
    ...
    public Collection<String> getMappingBasePackages() {
        return Collections.singleton("com.ssf.ancservice");
    }
}