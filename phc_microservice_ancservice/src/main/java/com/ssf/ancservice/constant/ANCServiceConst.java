...
public final class ANCServiceConst {

    public static final String ANC_SERVICE_COLLECTION_NAME = "ANCService";
    public static final String ANC_VISIT_LOG_COLLECTION_NAME = "ANCServiceVisitLog";
