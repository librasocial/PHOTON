...
import com.ssf.product.constant.SecretsConstant;
...
@Configuration
@DependsOn({"secrets"})
@EnableMongoRepositories(basePackages = "com.ssf.product.repository")
public class MongoConfig extends AbstractMongoClientConfiguration {
    ...
    public Collection<String> getMappingBasePackages() {
        return Collections.singleton("com.ssf.product.repository");
    }
}