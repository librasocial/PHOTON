...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleAuthroizationExcpetion(UnsupportedJwtException ex) {
    ...
    protected ResponseEntity<Object> handleMissmatchException(
            MissmatchException ex) {
        log.error("MissMatch exception {}  ", ex);
        ...
        ApiError apiError = ApiError.builder()
                .description("MissMatch exception")
                .errors(errorList).build();
        return buildResponseEntity(apiError, BAD_REQUEST);
    }
