package com.ssf.pncregistration.kafka.producer.client;

import com.ssf.pncregistration.config.ApplicationSecretConfig;
import com.ssf.pncregistration.kafka.producer.PNCRProducer;
import com.ssf.pncregistration.kafka.producer.factory.PNCRProducerFactory;
...
public class KafkaProducerClient {
    ...
    @Autowired
    private PNCRProducerFactory factory;
    ...
    public void publishToTopic(String topic, KafkaMessage kafkaMessage) {
        ...
        PNCRProducer producer = factory.createProducer(applicationSecretConfig.getSecretKey(SecretsConstant.KAFKA_BROKERS), clientId, keySerializer, valueSerializer);
