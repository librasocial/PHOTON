...
const apiErrorHandler = require("./app/middlewares/api-error-handler.js");
...
(async () => {
  ...
  console.log(process.env.profile);
    ...
    .then(() => {
        ...
        DB_LINK = DB_LINK.concat('/',profile).concat('-','medicalknowledge')
...
const actuatorOptions = {
	basePath: "/medicalknowledge", // It will set /management/info instead of /info
};
...
app.use("/medicalknowledge", router);
