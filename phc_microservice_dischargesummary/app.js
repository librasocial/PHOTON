...
(async () => {
  ...
  console.log(process.env.profile);
    ...
    .then(() => {
        ...
        DB_LINK = DB_LINK.concat('/',profile).concat('-','dischargesummary')
...
const actuatorOptions = {
  basePath: '/dischargesummary' // It will set /management/info instead of /info
}
...
app.use('/dischargesummary', router)
