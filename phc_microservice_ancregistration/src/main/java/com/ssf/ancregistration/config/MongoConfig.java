...
import com.ssf.ancregistration.utils.SecretsConstant;
...
@Configuration
@DependsOn({"secrets"})
@EnableMongoRepositories(basePackages = "com.ssf.ancregistration")
public class MongoConfig extends AbstractMongoClientConfiguration {
    ...
    protected String getDatabaseName() {
        return environment + "-ancregistration";
    }
    ...
    public Collection<String> getMappingBasePackages() {
        return Collections.singleton("com.ssf.ancregistration");
    }
}