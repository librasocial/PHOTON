...
import com.ssf.immunization.constant.SecretsConstant;
...
@Configuration
@DependsOn({"secrets"})
@EnableMongoRepositories(basePackages = "com.ssf.immunization.repository")
public class MongoConfig extends AbstractMongoClientConfiguration {
    ...
    protected String getDatabaseName() {
        return environment + "-immunization";
    }
    ...
    public Collection<String> getMappingBasePackages() {
        return Collections.singleton("com.ssf.immunization.repository");
    }
}