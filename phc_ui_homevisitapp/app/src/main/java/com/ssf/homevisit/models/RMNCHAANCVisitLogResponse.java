...
public class RMNCHAANCVisitLogResponse {
    ...
    @Expose
    public ArrayList<String> highRiskSymptoms;
    ...
    public ArrayList<String> getHighRiskSymptoms() {
        return highRiskSymptoms;
    }

    public void setHighRiskSymptoms(ArrayList<String> highRiskSymptoms) {
    ...
    public RMNCHAANCVisitLogResponse() {
