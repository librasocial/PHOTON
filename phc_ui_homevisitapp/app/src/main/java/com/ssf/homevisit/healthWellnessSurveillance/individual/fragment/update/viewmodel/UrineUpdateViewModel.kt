...
@HiltViewModel
class UrineUpdateViewModel @Inject constructor(private val repo: IGetSurveillance) : ViewModel() {
    ...
    fun updateUrine(requestData: UrineRequestData, surveillanceId: String) {
        viewModelScope.launch {
            repo.updateUrineData(requestData, surveillanceId).onEach {
                when (it) {
