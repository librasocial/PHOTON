package com.ssf.homevisit.rmncha.anc.ancalert;
...
import com.ssf.homevisit.rmncha.anc.mapping.ANCMappingFragment;

import java.util.ArrayList;
import java.util.List;

public class ANCAlert {
    ...
    private PhcResponse.Content rmnchaSelectedPhc;
    private SubcentersFromPHCResponse.Content rmnchaSelectedSubCenter;
    private SubCVillResponse.Content rmnchaSelectedVillage;

    private Activity activityContext;
    private ANCAlertViewModel ancAlertViewModel;

    public ANCAlert(Activity activityContext) {
        this.activityContext = activityContext;
        ancAlertViewModel = new ANCAlertViewModel(((Activity) activityContext).getApplication());
    }

    public void displayANCMappingAlert() {
        ...
        rmnchaBinding.title.setText("Select Village for Ante Natal Care");
        ...
        rmnchaBinding.btnStartMap.setOnClickListener(view -> {
            ANCMappingFragment fragment = new ANCMappingFragment();
        ...
        rmnchaPhcLiveData = ancAlertViewModel.getPhcLiveData();
        ...
        rmnchaBinding.spinnerPhc.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                rmnchaSubCenterLiveData = ancAlertViewModel.getSubcentersFromPHCResponseLiveData(uuid);
            }
        ...
        rmnchaSubCenterLiveData = ancAlertViewModel.getSubcentersFromPHCResponseLiveData("");
        ...
        rmnchaBinding.spinSubCenter.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                rmnchaVillageLiveData = ancAlertViewModel.getVillagesFromSubcentersLiveData(uuid);
            }
        ...
        rmnchaVillageLiveData = ancAlertViewModel.getVillagesFromSubcentersLiveData("");
