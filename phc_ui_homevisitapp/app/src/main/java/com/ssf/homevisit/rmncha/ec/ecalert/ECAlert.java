package com.ssf.homevisit.rmncha.ec.ecalert;
...
import com.ssf.homevisit.rmncha.ec.mapping.ECMappingFragment;
...
public class ECAlert {
    ...
    private ECAlertViewModel ECAlertViewModel;

    public ECAlert(Activity activityContext) {
        this.activityContext = activityContext;
        ECAlertViewModel = new ECAlertViewModel(((Activity) activityContext).getApplication());

    }


    public void displayECMappingAlert() {
        ...
        rmnchaBinding.title.setText("Select Village for Eligible Couple Process");
        ...
        rmnchaBinding.btnStartMap.setOnClickListener(view -> {
            ECMappingFragment fragment = new ECMappingFragment();
        ...
        rmnchaPhcLiveData = ECAlertViewModel.getPhcLiveData();
        ...
        rmnchaBinding.spinnerPhc.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                rmnchaSubCenterLiveData = ECAlertViewModel.getSubcentersFromPHCResponseLiveData(uuid);
            }
        ...
        rmnchaSubCenterLiveData = ECAlertViewModel.getSubcentersFromPHCResponseLiveData("");
        ...
        rmnchaVillageLiveData = ECAlertViewModel.getVillagesFromSubcentersLiveData("");
