...
@HiltViewModel
class BloodSmearUpdateViewModel @Inject constructor(private val repo: IGetSurveillance) :
    ViewModel() {
    ...
    fun updateBloodSmear(requestData: BloodSmearUpdateRequestData, surveillanceId: String) {
        viewModelScope.launch {
            repo.updateBloodSmearData(requestData, surveillanceId).onEach {
                when (it) {
