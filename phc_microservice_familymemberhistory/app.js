...
(async () => {
  ...
  console.log(process.env.profile);
    ...
    .then(() => {
        ...
        DB_LINK = DB_LINK.concat('/',profile).concat('-','familymemberhistory')
...
const actuatorOptions = {
	basePath: "/familymemberhistory", // It will set /management/info instead of /info
};
...
app.use("/familymemberhistory", router);
