...
@Configuration
@DependsOn({ "secrets" })
@EnableMongoRepositories(basePackages = "com.ssf.adolescentcare.repository")
public class MongoConfig extends AbstractMongoClientConfiguration {
	...
	protected String getDatabaseName() {
		return environment + "-adolescentcare";
	}
	...
	public Collection<String> getMappingBasePackages() {
		return Collections.singleton("com.ssf.adolescentcare.repository");
	}
}
