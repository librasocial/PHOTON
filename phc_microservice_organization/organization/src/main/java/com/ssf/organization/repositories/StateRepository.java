...
public interface StateRepository extends Neo4jRepository<State, String> {
	...
	public Page<State> findStateByName(String name, Pageable pageable);
	...
	public Page<State> findStateRel(String sourceId, String rel, Pageable pageable);
    
	public Optional<State> findByUuid(String id);
}
