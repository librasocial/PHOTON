package com.ssf.organization.kafka.producer.client;
...
public class KafkaProducerClient {
    ...
    @Autowired
    private OrganizationProducerFactory factory;
    @Value("${spring.env}")
    private String env;
    ...
    public void publishToTopic(String topic, KafkaMessage kafkaMessage) {
        ...
        OrganizationProducer producer = factory.createProducer(applicationSecretConfig.getSecretKey(SecretsConstant.KAFKA_BROKERS), clientId, "org.apache.kafka.common.serialization.StringSerializer", "org.springframework.kafka.support.serializer.JsonSerializer");
