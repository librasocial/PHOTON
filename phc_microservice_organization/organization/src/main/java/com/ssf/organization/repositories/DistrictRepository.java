...
public interface DistrictRepository extends Neo4jRepository<District, String>{
	public Page<District> findDistrictByName(String name, Pageable pageable);
	...
	public Page<District> findDistrictRel(String sourceId, String rel, Pageable pageable);
	
	public Optional<District> findByUuid(String id);
